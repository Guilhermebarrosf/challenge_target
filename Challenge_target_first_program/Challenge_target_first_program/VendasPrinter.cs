...
{
    public static void printerComission(List<Venda> vendas, int comission, double priceDetermined, bool receiverComission)
    {
        if (receiverComission)
        {
            Console.WriteLine($"\n\n--- Commission {comission}% (< R${priceDetermined}) ---\n");
        ...
        Console.WriteLine($"\n--- Without Commission (<= R${priceDetermined}) ---\n");
        foreach (var v in vendas)
        {
